...
export class MeshyAIService {
  ...
  async createImageTo3DTask(
    ...
    const requestBody: MeshyImageTo3DRequest = {
      mode: settings.mode,
      image_url: imageUrl,
      text_prompt: textPrompt || 'full body character in PERFECT T-POSE STANCE, EXACTLY TWO ARMS ONLY, COMPLETELY OVERRIDE original arm positioning, REPLACE any raised arm with horizontal T-pose, DISCARD source pose completely, BOTH arms extended horizontally at EXACT same shoulder height, arms perfectly parallel to ground, left arm and right arm at identical height, NO asymmetrical arm positioning, NO one arm raised higher than the other, NO extended arm gestures, NO arm pointing, NO reaching poses, ONLY TWO ARMS TOTAL, NO EXTRA ARMS, NO ADDITIONAL LIMBS, complete anatomy with all limbs visible, facing forward, neutral expression, proper proportions, clean geometry, anatomically correct, symmetrical body positioning, equal length arms',
      enable_pbr: settings.enable_pbr, // Plan-specific PBR settings
      ...
      texture_richness: settings.texture_richness, // Plan-specific texture settings
      should_remesh: false, // Disable remesh to avoid processing issues
      negative_prompt: negativePrompt || 'sitting, crouching, bent arms, crossed arms, arms at sides, arms down, hands on hips, closed pose, action pose, dynamic pose, non-standard pose, partial body, side view, back view, three-quarter view, profile view, deformed, distorted, malformed, asymmetrical, incomplete limbs, missing arms, missing legs, rough textures, poor geometry, pixelated, low quality, asymmetrical arms, uneven arms, one arm raised, one arm up, one arm down, different arm heights, arm length differences, unequal arm positioning, raised arm, lowered arm, arm asymmetry, arm imbalance, extended arm, reaching arm, arm gesture, arm pointing, extra long arms, oversized arms, stretched arms, elongated limbs, disproportionate arms, wrong arm proportions, arm stretching, arm distortion, arm deformation, unnatural arm length, keep original arm position, maintain original pose, preserve arm gesture, retain raised arm, keep extended arm, maintain arm asymmetry, original arm positioning, source pose retention, pose preservation, extra arms, multiple arms, additional arms, too many arms, duplicate arms, arm duplication, arm multiplication, three arms, four arms, more than two arms, arm extending from hand, arm growing from hand, hand with attached arm, arm sprouting from palm, extra appendages, additional limbs, limb duplication, appendage multiplication', // Comprehensive negative prompts with extra arm exclusions
      art_style: `T-pose character, standing straight, arms extended horizontally at shoulder height, neutral stance, ${settings.art_style_emphasis}` // Enhanced T-pose emphasis
    };
  ...
  private getSubscriptionSettings(userPlan: string) {
    const settings = {
      free: {
        ...
        art_style_emphasis: 'clean geometry, proper proportions, maintain original style, symmetrical arms, equal arm lengths'
      },
      reply_guy: {
        mode: 'preview' as const,
        enable_pbr: false,
        ...
        art_style_emphasis: 'enhanced proportions, clean texture mapping, preserve character features, force symmetrical pose, correct arm positioning'
      },
      spartan: {
        mode: 'preview' as const,
        enable_pbr: false,
        ...
        art_style_emphasis: 'professional quality, accurate anatomy, detailed features, style preservation, perfect T-pose symmetry, identical arm heights'
      },
      zeus: {
        ...
        art_style_emphasis: 'high quality geometry, PBR materials, precise anatomy, enhanced details, forced symmetrical T-pose, override asymmetrical positioning'
      },
      goat: {
        mode: 'refine' as const,
        enable_pbr: true,
        ...
        art_style_emphasis: 'premium quality, advanced materials, perfect anatomy, ultra-detailed features, absolute T-pose perfection, complete symmetrical correction'
      }
    };
