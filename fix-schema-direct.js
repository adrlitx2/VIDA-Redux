// Fix schema using Supabase service role key - same approach that worked before
...
async function fixSchema() {
  ...
  try {
    ...
    const { error: indexError } = await supabase.rpc('exec_sql', {
      sql: 'DROP INDEX IF EXISTS co_stream_invitations_session_invitee_unique; CREATE UNIQUE INDEX co_stream_invitations_session_invitee_unique ON co_stream_invitations(session_id, invitee_id);'
    });
