            ...
            <Card key={plan.id} className="relative">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex flex-wrap gap-1">
                  {plan.customAvatars && <Badge variant="outline" className="text-xs">Custom Avatars</Badge>}
                  {plan.prioritySupport && <Badge variant="outline" className="text-xs">Priority Support</Badge>}
                  {plan.xSpacesHosting && <Badge variant="outline" className="text-xs">X Spaces</Badge>}
                  {plan.riggingStudioAccess && <Badge variant="outline" className="text-xs">Rigging Studio</Badge>}
                  {plan.autoRiggingEnabled && <Badge variant="outline" className="text-xs">Auto-Rigging</Badge>}
                </div>
              </CardContent>
            </Card>
          ))}
